...
| 33:00-37:00 | `lesson12-020`, `lesson12-021` | Contrast one answer-good/path-bad case with one path-good/answer-incomplete case and assign the earliest public owner. | Two diagnostic rows and Figure 6, **Failure diagnosis assigns the earliest public owner**, across planner, tool boundary, replanner, evidence gate, report writer, dataset, and judge. |
